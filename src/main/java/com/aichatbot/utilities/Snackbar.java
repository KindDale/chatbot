package com.aichatbot.utilities; // Change to your actual package
...
/**
 * A simple Snackbar-like notification system using JavaFX Popup.
 */
public class Snackbar {
    public static void show(Stage stage, String message) {
        ...
        // Fade in
        FadeTransition c2w_ai_fadeIn = new FadeTransition(Duration.millis(300), c2w_ai_label);
